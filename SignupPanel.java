...
/**
 * SignupPanel
 * Displays the sign up screen where the user can create an account
 * with an email and password.
 */
public class SignupPanel extends JPanel {

    private GUI app;     // Reference to main GUI app to access shared state and navigation

    /**
     * Constructs the signup screen.
     */
    public SignupPanel(GUI app) {
        this.app = app;

        // Use manual layout so we can position components with setBounds
        setLayout(null);
        setBackground(new Color(245, 245, 245)); // Light gray background
        setBorder(BorderFactory.createEmptyBorder(30, 30, 30, 30));

        // Used to roughly center content on the screen
        ...
        signupButton.addActionListener(e -> {
            ...
            // Prevent duplicate registration if email is already used
            ...
            // checks to see if it is valid email
    ...
    /**
     * Paints the panel background image.
     */
    @Override
